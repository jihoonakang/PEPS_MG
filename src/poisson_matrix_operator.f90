module poisson_matrix_operator
    ...
    subroutine  vv_dot_3d_matrix0(result, x, y, nx, ny, nz, is_serial)
    ...
    end subroutine  vv_dot_3d_matrix0

    subroutine mv_mul_poisson_matrix0(y, a_poisson, x, dm, is_serial)
    ...
    end subroutine mv_mul_poisson_matrix0
